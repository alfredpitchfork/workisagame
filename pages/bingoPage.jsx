...
const bingoPage = () => {
	...
	return (
		<div>
			...
			<div className='main_body h-screen w-screen flex justify-center flex-col items-center sm:mt-16 sm:justify-items-center'>
				<div className=''>
					<button
				...
				<div className='mt-10 w-screen h-4/5  sm:w-[100%] '>
